...
# Form implementation generated from reading ui file 'sys_delete.ui'
#
...
class Ui_Dialog_stu_delete(object):
    def setupUi(self, Dialog_stu_delete):
        ...
        Dialog_stu_delete.resize(335, 237)
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        ...
        self.label.setGeometry(QtCore.QRect(70, 20, 201, 30))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        ...
        self.lineEdit.setGeometry(QtCore.QRect(60, 120, 211, 31))
        self.lineEdit.setObjectName("lineEdit")
        self.comboBox = QtWidgets.QComboBox(Dialog_stu_delete)
        self.comboBox.setGeometry(QtCore.QRect(30, 70, 176, 28))
    ...
    def retranslateUi(self, Dialog_stu_delete):
        ...
        self.label.setText(_translate("Dialog_stu_delete", "管理员账号删除"))
        self.comboBox.setItemText(0, _translate("Dialog_stu_delete", "学生管理员-工号"))
        self.comboBox.setItemText(1, _translate("Dialog_stu_delete", "学生管理员-姓名"))
        self.comboBox.setItemText(2, _translate("Dialog_stu_delete", "图书管理员-工号"))
        self.comboBox.setItemText(3, _translate("Dialog_stu_delete", "图书管理员-姓名"))
