...
class Ui_Dialog_read(object):
    def setupUi(self, Dialog_read):
        ...
        Dialog_read.resize(613, 697)
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(12)
        Dialog_read.setFont(font)
        self.textBrowser = QtWidgets.QTextBrowser(Dialog_read)
        self.textBrowser.setGeometry(QtCore.QRect(30, 110, 551, 521))
        self.textBrowser.setObjectName("textBrowser")
        self.pushButton_2 = QtWidgets.QPushButton(Dialog_read)
        self.pushButton_2.setGeometry(QtCore.QRect(340, 650, 109, 31))
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton = QtWidgets.QPushButton(Dialog_read)
        self.pushButton.setGeometry(QtCore.QRect(480, 650, 93, 31))
        ...
        self.pushButton_3 = QtWidgets.QPushButton(Dialog_read)
        self.pushButton_3.setGeometry(QtCore.QRect(460, 70, 93, 31))
    ...
    def retranslateUi(self, Dialog_read):
        ...
        self.pushButton_2.setText(_translate("Dialog_read", "借阅该图书"))
        self.pushButton.setText(_translate("Dialog_read", "退出"))
        self.label.setText(_translate("Dialog_read", "请输入书号："))
        self.label_2.setText(_translate("Dialog_read", "在线浏览"))
        self.pushButton_3.setText(_translate("Dialog_read", "浏览"))
